...
{
    // tempSensorSerial = config.dallasSerials;
...
{
    getTemperature(MODULES_COUNT, false); // MODULES_COUNT is the ambient temp sensor array pointer. 0-3 / 0-7 are the modules pointers and 4 or 8 is the 5th or 8th temp sensor
