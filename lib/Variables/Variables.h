...
const float shuntResistor[modulesCount] = {3.33, 3.33, 3.38, 3.37};
const float chargeLedPinMidVoltage[modulesCount] = {2.04, 2.09, 2.15, 2.09}; // Array for each Mid On / Off Voltage of the TP5100 Charge LED Pins
...
const float referenceVoltage = 4.98;           // 5V output of Arduino
...
const float batteryVoltageLeak = 0.50;         // On the initial screen "BATTERY CHECK" observe the highest voltage of each module and set this value slightly higher
