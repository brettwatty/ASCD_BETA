...
const float shuntResistor[modulesCount] = {3.4, 3.34, 3.38, 3.33};
const float chargeLedPinMidVoltage[modulesCount] = {2.04, 2.06, 2.1, 2.12}; // Array for each Mid On / Off Voltage of the TP5100 Charge LED Pins
...
const float batteryVoltageLeak = 2.20;         // On the initial screen "BATTERY CHECK" observe the highest voltage of each module and set this value slightly higher
